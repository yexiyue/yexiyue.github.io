<template>
  <div
    ...
    <div class="cover">
      ...
      || this.pageImageList[Math.ceil(Math.random()*10)%8]" :alt="item.title"/>
    </div>
    <div class="info">
      <div class="title">
  ...
  export default {
    ...
    data:()=>{
      return {
        //配置封面图片随机
        pageImageList:[
          '\/pageImage/cover1.jpg',
          '\/pageImage/cover2.jpg',
          '\/pageImage/cover3.jpg',
          '\/pageImage/cover4.jpg',
          '\/pageImage/cover5.jpg',
          '\/pageImage/cover6.jpg',
          '\/pageImage/cover7.jpg',
          '\/pageImage/cover8.jpg',
        ]
      }
    }
  }
